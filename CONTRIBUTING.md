...
1. Make an [Issue](https://github.com/vel/velutils-ovr/issues/new)
...
```json
    {
        "dependencies": {
            "com.vel.velutils-ovr": "https://github.com/YOUR_USER/velutils-ovr.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at support@velaboratory.com.
